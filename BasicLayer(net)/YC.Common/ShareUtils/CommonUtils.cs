...
namespace YC.Common.ShareUtils
{
    ...
    public class CommonUtils
    {
        ...
        /// <returns></returns>
        public static Dictionary<string, string> GetObjectToDict<T>(T entity) where T:class,new() {

            Dictionary<string, string> dic = new Dictionary<string, string>();
            System.Reflection.PropertyInfo[] pr = entity.GetType().GetProperties();
        ...
        /// <returns></returns>
        public static String GetASCIIOrderbyParam(Dictionary<string, string> paramsMap,string symbol="&",bool containKey=false)
        {
            ...
            foreach (KeyValuePair<string, string> kv in vDic)
            {
                ...
                if (containKey)
                {
                    ...
                    str.Append(pkey + "=" + pvalue + "symbol");
                }
                else {
                   
                    str.Append(pvalue + symbol);
                }
