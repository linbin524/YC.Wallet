...
namespace YC.Common.ShareUtils
{
    public static class JsonUtils
    {
        ...
        /// <summary>
        /// 如果是object类型就没法tojson  请不要用这个方法，会异常，有些时间类型为null 也会解析异常
        ...
        public static string ToMsJson(this object obj)
        {
            //参数是object 类 会报错出现异常，无法转换object 类型的数据
        ...
        public static T GetObjectByJsonKey<T>(this string Json, string key)
        {
