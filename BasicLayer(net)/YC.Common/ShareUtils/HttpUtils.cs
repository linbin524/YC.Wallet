...
namespace YC.Common.ShareUtils
{
    public class HttpUtils
    {
        ...
        public static string UserAgent = "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; QQWubi 133; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; CIBA; InfoPath.2)";
        #region POST
        ...
        /// <returns></returns>
        public static string HttpPost(string url, string defaultContentType = "Application/Json-Rpc", string param = null, Dictionary<string, string> header = null)
        {
            ...
            request.Accept = "*/*";
            request.UserAgent = HttpUtils.UserAgent;
            if (header != null)
            {
            ...
            try
            {
                ...
                //var rpcRequestJson = JsonConvert.SerializeObject(param);
                //byte[] postData = Encoding.UTF8.GetBytes(rpcRequestJson);
        ...
        /// <param name="url">URL.</param>
        /// <returns></returns>
        public static string HttpPut(string url, string defaultContentType = "Application/Json-Rpc", string param = null, Dictionary<string, string> header = null)
        {
            HttpWebRequest request;
        ...
        /// <param name="url">URL.</param>
        /// <returns></returns>
        public static string HttpDelete(string url, string param = null, string defaultContentType = "Application/Json-Rpc", Dictionary<string, string> header = null)
        {
            HttpWebRequest request;
        ...
        /// <param name="url">URL.</param>
        /// <returns></returns>
        public static string HttpGet(string url, string defaultContentType = "Application/Json-Rpc", Dictionary<string, string> header = null)
        {
            HttpWebRequest request;
        ...
        public static string HttpGet(string url, Encoding encodeing, string defaultContentType = "Application/Json-Rpc", Dictionary<string, string> header = null)
        {
            HttpWebRequest request;
